...
<div class="row mb-1 justify-content-end">
    <a href="{{ action('SubjectStudentController@add', $subject->id_subject) }}" class="btn btn-success" role="button">Actualizar estudiante</a>
</div>
            ...
            @if($subject_students->count())  
                @foreach($subject_students as $subject_student)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-xs" href="{{action('SubjectStudentController@data', [$subject_student->id_subject_student])}}"><i class="fa fa-info-circle"></i></a>
                        </td>
                    </tr>
                @endforeach 
            @else
